...
namespace CommentForm.Controllers
{
    public class ProceduresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Priority,Title,Details")] Procedure procedure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Priority,Title,Details")] Procedure procedure)
        {
            if (ModelState.IsValid)
            {
